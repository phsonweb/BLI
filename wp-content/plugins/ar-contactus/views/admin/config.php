        ...
        <div class="ui grid">
            <div class="four wide column">
                <div class="ui vertical fluid pointing menu" id="acrontactus-menu">
                    ...
                    <a class="item <?php echo (in_array($activeSubmit, ['ArContactUsConfigButton', 'ArContactUsConfigMobileButton']))? 'active' : '' ?>" data-target="#arcontactus-button">
                        <?php echo __('Button settings', 'ar-contactus') ?>
                    </a>
                    <a class="item <?php echo (in_array($activeSubmit, ['ArContactUsConfigMenu', 'ArContactUsConfigMobileMenu']))? 'active' : '' ?>" data-target="#arcontactus-menu">
                    ...
                    <a class="item <?php echo (in_array($activeSubmit, ['ArContactUsConfigPrompt', 'ArContactUsConfigMobilePrompt']))? 'active' : '' ?>" data-target="#arcontactus-prompt">
                    ...
                    <a class="item <?php echo ($activeSubmit == 'importDataSubmit')? 'active' : '' ?>" data-target="#arcontactus-data">
        ...
        <div class="ui form" style="padding: 20px;">
            <div class="ui grid">
                ...
                <div class="row">
                    ...
                    <div class="ten wide column">
                        <div class="field required">
                            <label><?php echo __('Display on', 'ar-contactus') ?></label>
                ...
                <div class="row arcu-link-group">
                    ...
                    <div class="ten wide column">
                        <div class="field required">
                            <label><?php echo __('Link', 'ar-contactus') ?></label>
...
<script>
    window.addEventListener('load', function(){
        ...
        if (jQuery.fn.modal && jQuery.fn.modal.noConflict){
