...
abstract class ArContactUsConfigModel extends ArContactUsConfigModelAbstract
{
    ...
    public function attributeDescriptions()
    {
        return array(
            ...
            'pages' => __('You can disable widget on several pages. Please use relative URLs. For example, to disable widget on home page write "/" (without qoutes). One URL per line.', 'ar-contactus'),
            ...
            'twilio_message' => __('{phone} token will be replaced to phone entered in callback request form. {site} token will be replaced to site domain', 'ar-contactus'),
            'onesignal_title' => __('{phone} token will be replaced to phone entered in callback request form. {site} token will be replaced to site domain', 'ar-contactus'),
            'onesignal_message' => __('{phone} token will be replaced to phone entered in callback request form. {site} token will be replaced to site domain', 'ar-contactus'),
            ...
            'tg_chat_id' => __('Messages will be received to this chatID. To know your chatID please write to bot t.me/userinfobot', 'ar-contactus'),
            'tg_text' => __('This message will be received to your telegram. {phone} token will be replaced to phone entered in callback request form', 'ar-contactus'),
    ...
    public function htmlFields()
    {
        return array(
            ...
            'onesignal_alert' => '<div class="ui orange message" style="display: block">' . __('Onesignal requires HTTPS', 'ar-contactus') . '</div>',
