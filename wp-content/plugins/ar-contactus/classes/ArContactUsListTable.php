...
class ArContactUsListTable extends WP_List_Table
{
    ...
    public function get_columns() {
        $columns = array(
            ...
            'id_user'    => _x('User','Column label', 'ar-contactus'),
            'phone'   => _x('Phone','Column label', 'ar-contactus'),
            'created_at' => _x('Created at','Column label', 'ar-contactus'),
            'status' => _x('Status','Column label', 'ar-contactus'),
        );
        return $columns;
    }
    ...
    protected function prepare_data()
    {
        ...
        $data = array();
        $q = ArContactUsCallbackModel::find()->offset($page * $perPage)->limit($perPage);
        if ($order && $orderby){
